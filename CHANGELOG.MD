...
## [3.2.0](../../compare/3.1.0...3.2.0) - 2026-03-28
### Added
- `self:get_type()` method to get additional information about the current type
- `self:get_type_name()` method to return the current instance's classname
